...
// Multi Bed Heating via ADS1115
//
#if TEMP_SENSOR_BED == 3000
  #define USE_ADS1115_BED_SENSORS       // Ativa suporte ao ADS1115 para ler até 4 mesas
  #define USE_MULTI_BED_HEATING         // Ativa controle individual de aquecimento para cada mesa
#endif
